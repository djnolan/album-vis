...
export const illmatic = {
  ...
  songs: [
    ...
    { track: 3,  name: "Life's a Bitch",                   duration: 210, bpm: 90, key: "G", accidental: "natural", mode: "major" },
    { track: 4,  name: "The World Is Yours",               duration: 290, bpm: 87, key: "A", accidental: "sharp",   mode: "minor" },
    { track: 5,  name: "Halftime",                         duration: 260, bpm: 92, key: "E", accidental: "natural", mode: "minor" },
    { track: 6,  name: "Memory Lane (Sittin' in da Park)", duration: 248, bpm: 90, key: "C", accidental: "natural", mode: "major" },
    { track: 7,  name: "One Love",                         duration: 325, bpm: 93, key: "C", accidental: "natural", mode: "major" },
    { track: 8,  name: "One Time 4 Your Mind",             duration: 198, bpm: 78, key: "E", accidental: "natural", mode: "minor" },
    { track: 9,  name: "Represent",                        duration: 252, bpm: 93, key: "C", accidental: "sharp",   mode: "major" },
    { track: 10, name: "It Ain't Hard to Tell",            duration: 202, bpm: 91, key: "B", accidental: "natural", mode: "minor" },
  ],
};
...
export const momentOfTruth = {
  ...
  songs: [
    ...
    { track: 3,  name: "Work",                     duration: 177, bpm: 93,  key: "C", accidental: "sharp",   mode: "major" },
    { track: 4,  name: "Royalty",                  duration: 251, bpm: 90,  key: "G", accidental: "natural", mode: "major" },
    { track: 5,  name: "Above The Clouds",         duration: 225, bpm: 172, key: "G", accidental: "sharp",   mode: "major" },
    { track: 6,  name: "JFK 2 LAX",               duration: 199, bpm: 89,  key: "C", accidental: "sharp",   mode: "major" },
    { track: 7,  name: "Itz A Set Up",             duration: 176, bpm: 177, key: "G", accidental: "sharp",   mode: "major" },
    { track: 8,  name: "Moment Of Truth",          duration: 250, bpm: 90,  key: "F", accidental: "sharp",   mode: "minor" },
    { track: 9,  name: "B.I. Vs. Friendship",      duration: 256, bpm: 177, key: "C", accidental: "sharp",   mode: "major" },
    { track: 10, name: "The Militia",              duration: 289, bpm: 94,  key: "C", accidental: "sharp",   mode: "major" },
    { track: 11, name: "The Rep Growz Bigga",      duration: 217, bpm: 91,  key: "C", accidental: "sharp",   mode: "minor" },
    { track: 12, name: "What I’m Here 4",          duration: 165, bpm: 91,  key: "C", accidental: "natural", mode: "minor" },
    { track: 13, name: "She Knowz What She Wantz", duration: 181, bpm: 83,  key: "G", accidental: "natural", mode: "minor" },
    { track: 14, name: "New York Strait Talk",     duration: 204, bpm: 93,  key: "F", accidental: "sharp",   mode: "minor" },
    { track: 15, name: "My Advice 2 You",          duration: 152, bpm: 89,  key: "A", accidental: "sharp",   mode: "minor" },
    { track: 16, name: "Make 'Em Pay",             duration: 261, bpm: 87,  key: "E", accidental: "natural", mode: "minor" },
    { track: 17, name: "The Mall",                 duration: 221, bpm: 87,  key: "B", accidental: "natural", mode: "minor" },
    { track: 18, name: "Betrayal",                 duration: 289, bpm: 148, key: "C", accidental: "natural", mode: "minor" },
    { track: 19, name: "Next Time",                duration: 186, bpm: 89,  key: "G", accidental: "sharp",   mode: "major" },
    { track: 20, name: "In Memory Of...",          duration: 229, bpm: 83,  key: "D", accidental: "natural", mode: "minor" },
  ],
};
