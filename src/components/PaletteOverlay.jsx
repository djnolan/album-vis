...
const FLOWER_CONFIGS = [
  ...
  [
    { acc:'sharp',   bpm:105, size:80, cx:36, cy:50, rot:30,  col:'start', track:1   },
    { acc:'natural', bpm:60,  size:54, cx:65, cy:50, rot:160, col:'end',   track:51  },
  ],
  // 1: natural big left upper, sharp small right lower
  [
    { acc:'natural', bpm:75,  size:80, cx:37, cy:28, rot:45,  col:'end',   track:8   },
    { acc:'sharp',   bpm:120, size:54, cx:64, cy:72, rot:200, col:'start', track:58  },
  ],
  // 2: sharp small left lower, natural big right upper
  [
    { acc:'sharp',   bpm:45,  size:54, cx:36, cy:72, rot:300, col:'start', track:15  },
    { acc:'natural', bpm:90,  size:80, cx:64, cy:28, rot:80,  col:'end',   track:65  },
  ],
  // 3: sharp big right-center, natural small left-center (colors swapped)
  [
    { acc:'sharp',   bpm:120, size:80, cx:64, cy:50, rot:120, col:'end',   track:22  },
    { acc:'natural', bpm:60,  size:54, cx:36, cy:50, rot:250, col:'start', track:72  },
  ],
  // 4: natural big left upper (few petals), sharp small right lower
  [
    { acc:'natural', bpm:45,  size:80, cx:37, cy:28, rot:15,  col:'start', track:29  },
    { acc:'sharp',   bpm:105, size:54, cx:63, cy:72, rot:180, col:'end',   track:79  },
  ],
  // 5: sharp big left lower, natural small right upper
  [
    { acc:'sharp',   bpm:75,  size:80, cx:36, cy:72, rot:60,  col:'start', track:36  },
    { acc:'natural', bpm:120, size:54, cx:65, cy:28, rot:280, col:'end',   track:86  },
  ],
  // 6: natural big right (many petals), sharp small left
  [
    { acc:'natural', bpm:135, size:80, cx:63, cy:35, rot:330, col:'end',   track:43  },
    { acc:'sharp',   bpm:60,  size:54, cx:37, cy:65, rot:90,  col:'start', track:93  },
  ],
  // 7: sharp big left-center (many petals), natural small right
  [
    { acc:'sharp',   bpm:90,  size:80, cx:36, cy:50, rot:200, col:'start', track:50  },
    { acc:'natural', bpm:135, size:54, cx:64, cy:50, rot:10,  col:'end',   track:100 },
  ],
  // 8: natural small left upper, sharp big right lower
  [
    { acc:'natural', bpm:75,  size:54, cx:37, cy:28, rot:70,  col:'start', track:57  },
    { acc:'sharp',   bpm:105, size:80, cx:63, cy:72, rot:220, col:'end',   track:107 },
  ],
  // 9: sharp big left lower (few petals), natural small right upper (many)
  [
    { acc:'sharp',   bpm:60,  size:80, cx:36, cy:72, rot:100, col:'start', track:64  },
    { acc:'natural', bpm:135, size:54, cx:64, cy:28, rot:310, col:'end',   track:114 },
  ],
  // 10: natural big right upper, sharp small left lower
  [
    { acc:'natural', bpm:90,  size:80, cx:64, cy:28, rot:240, col:'end',   track:71  },
    { acc:'sharp',   bpm:75,  size:54, cx:36, cy:72, rot:40,  col:'start', track:121 },
  ],
  // 11: sharp big right (many petals), natural small left
  [
    { acc:'sharp',   bpm:135, size:80, cx:63, cy:50, rot:160, col:'start', track:78  },
    { acc:'natural', bpm:105, size:54, cx:37, cy:50, rot:340, col:'end',   track:128 },
  ],
];
